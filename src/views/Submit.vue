...
<template>
    <div>
        ...
        <fieldset>
            ...
            <input v-model.number="furR" type="number" /> <input v-model.number="furG" type="number" />
            <input v-model.number="furB" type="number" />
        </fieldset>
        <fieldset>
            <legend>瞳孔颜色 RGB</legend>
            <input v-model.number="eyeR" type="number" /> <input v-model.number="eyeG" type="number" />
